...
@_attrs_define
class ExtractResourcesWithSurveyResponse201Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        extract_resources_with_survey_response_201_data = cls(
            cooldown=cooldown,
            extraction=extraction,
            cargo=cargo,
            events=events,
        ...
        extract_resources_with_survey_response_201_data.additional_properties = d
        return extract_resources_with_survey_response_201_data
